...
public class Config extends MidnightConfig {
    ...
    @Comment(centered = true) public static Comment toggles;
    ...
    @Entry public static boolean toggleBans = false;
    @Entry public static boolean toggleCrates = false;
    @Entry public static boolean toggleVPRewards = false;
